...
/*  .sidebar-nav{
        	background: -webkit-linear-gradient(bule,skyblue);

			background: -o-linear-gradient(white,skyblue);

			background: -moz-linear-gradient(blue,skyblue);

			background: -mos-linear-gradient(white,color(69,122,172));
...
!-->
	...
	<div id="qwe" class="sidebar-nav">
		<a href="#dashboard-menu" class="nav-header" data-toggle="collapse"><i
			class="icon-dashboard"></i>学生管理</a>
		<ul id="dashboard-menu" class="nav nav-list collapse in">

			<li><a href="<%=contextPath %>/stu_list" target="content">
					浏览学生</a></li>
			<li><a href="<%=contextPath %>/main/stu_add.jsp"
				target="content">添加学生</a></li>
			<li><a href="<%=contextPath %>/main/import.jsp"
				target="content">导入数据</a></li>
			<li><a href="<%=contextPath %>/exportData">导出数据</a></li>
			<li><a href="<%=contextPath %>/main/login-stu.jsp"
				target="content">查询学生</a></li>
			<!--   <li ><a href="<%=contextPath %>/main/chat.jsp" target="content">数据统计</a></li>   -->
...
-->
		<a href="<%=contextPath %>/main/password_modify.jsp" target="content"
			class="#"><i class="icon-question-sign"></i>修改密码</a>
		<!--   <a href="#" class="#" ><i class="icon-comment"></i>Faq</a> -->
		<a target="_blank"
			href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=m6qrraypqaOrr6zb6uq1_PT2"
			style="text-decoration: none;"><i class="icon-comment"></i>意见反馈</a>
	</div>
