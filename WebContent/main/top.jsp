	...
	<div class="navbar">
		<div class="navbar-inner">
			<ul class="nav pull-right">
				...
				<li><a href="../logout.jsp" target="_parent"
					class="hidden-phone visible-tablet visible-desktop" role="button">退出</a></li>
				<li id="fat-menu" class="dropdown"><a href="#" role="button"
					class="dropdown-toggle" data-toggle="dropdown"> <i
						class="icon-user"></i><%= user.getUsername() %>

				</a></li>

			</ul>
			<a class="brand" href="#"> <span class="second">学生管理系统</span></a>
		</div>
	</div>
